...
- (id)init {
	...
	if (self) {
        ...
        // 敵を追加
        self._enemies = @[[Enemy createEnemy:1 x:184 y:-475],
                         [Enemy createEnemy:1 x:268 y:-475],
                         [Enemy createEnemy:1 x:352 y:-475]];
        ...
        // コインを追加
        self._coins = @[[Coin createCoin:1 x:600 y:-495],
                       [Coin createCoin:1 x:664 y:-495],
                       [Coin createCoin:1 x:728 y:-495],
                       [Coin createCoin:1 x:792 y:-495],
                       [Coin createCoin:1 x:852 y:-495],
                       [Coin createCoin:1 x:912 y:-495],
                       [Coin createCoin:1 x:972 y:-495],
                       [Coin createCoin:1 x:1032 y:-495]];
