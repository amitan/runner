...
- (id)init {
	...
	if (self) {
        ...
        self._blocks = [NSMutableArray arrayWithCapacity:8];
        ...
        block1.position = [PointUtil getPosition:600 y:-600];
        block2.position = [PointUtil getPosition:664 y:-600];
        block3.position = [PointUtil getPosition:728 y:-600];
        block4.position = [PointUtil getPosition:792 y:-600];
        block5.position = [PointUtil getPosition:856 y:-600];
        block6.position = [PointUtil getPosition:920 y:-600];
        block7.position = [PointUtil getPosition:984 y:-600];
        block8.position = [PointUtil getPosition:1048 y:-600];
